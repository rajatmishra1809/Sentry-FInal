...
import { Shield, ArrowRight, User, Globe, Heart, Lock } from 'lucide-react';
...
const Onboarding: React.FC<OnboardingProps> = ({ onComplete }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!name.trim()) {
      setError("Identification is required for system initialization.");
      return;
    }
      ...
      <div className="max-w-xl w-full px-6 animate-fade-in relative z-10">
        <div className="bento-card p-10 md:p-16 border-white/10 glass shadow-[0_50px_100px_rgba(0,0,0,0.8)] relative overflow-hidden group">
          ...
          <div className="mb-12">
            ...
            <p className="text-white/30 text-xs font-bold uppercase tracking-[0.4em]">Intelligence Access Terminal</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20 ml-1">Full Name</label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-transparent border-b border-white/10 pl-8 py-3 focus:border-blue-500 focus:outline-none transition-all text-white font-medium placeholder:text-white/5"
          ...
          <div className="mt-12 pt-8 border-t border-white/5 flex justify-between items-center opacity-30">
            <span className="text-[9px] font-mono tracking-widest uppercase">System v3.1 // 2025</span>
